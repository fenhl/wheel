...
impl IsNetworkError for io::Error {
    fn is_network_error(&self) -> bool {
        matches!(self.kind(), io::ErrorKind::BrokenPipe | io::ErrorKind::ConnectionAborted | io::ErrorKind::ConnectionRefused | io::ErrorKind::ConnectionReset | io::ErrorKind::TimedOut | io::ErrorKind::UnexpectedEof)
...
impl IsNetworkError for async_proto::ReadError {
    fn is_network_error(&self) -> bool {
        match &self.kind {
            ...
            #[cfg(feature = "tungstenite021")] async_proto::ReadErrorKind::Tungstenite(e) => e.is_network_error(),
            _ => false,
        }
    }
}
...
impl IsNetworkError for async_proto::WriteError {
    fn is_network_error(&self) -> bool {
        match &self.kind {
            ...
            #[cfg(feature = "tungstenite021")] async_proto::WriteErrorKind::Tungstenite(e) => e.is_network_error(),
            _ => false,
        }
    }
}
